"use strict";
$(function () {
  $("#startup-login-form").submit(function (event) {
    let username = $("#startup-login-form input[name=mobile_no]").val();
    let password = $("#startup-login-form input[name=password]").val();
