...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
    ...
    <div class="menu-item px-5">
        <a href="{{ route('admin.myprofile.view') }}" class="menu-link px-5">My Profile</a>
    </div>
    <!--end::Menu item-->
    <!--begin::Menu item-->
    {{-- <div class="menu-item px-5">
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-5 my-1">
        <a href="{{ route('admin.profile.notification.list') }}" class="menu-link px-5">Notifications</a>
    </div>
    <!--end::Menu item-->
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <a class="button-ajax menu-link px-5" href="#" data-action="{{ route('admin.logout') }}"
