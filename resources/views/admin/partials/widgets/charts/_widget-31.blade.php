...
<div class="card card-flush h-xl-100">
	<div class="card-header pt-7 mb-7">
		<h3 class="card-title align-items-start flex-column">
			<span class="card-label fw-bold text-gray-800">Warephase stats</span>
			<span class="text-gray-500 mt-1 fw-semibold fs-6">{{ $warephaseStats['subtitle'] ?? '8k social visitors'
				}}</span>
		</h3>
		<div class="card-toolbar">
			<a href="#" class="btn btn-sm btn-light">PDF Report</a>
	...
	<div class="card-body d-flex align-items-end pt-0">
		<div id="kt_charts_widget_31_chart" class="w-100 h-300px"></div>
		<!-- Pass your chart data via JS in the Blade file using $warephaseStats['data'] -->
	</div>
</div>
<!--end::Chart widget 31-->