...
<div class="card card-flush overflow-hidden h-lg-100">
    <div class="card-header pt-5">
        <h3 class="card-title align-items-start flex-column">
            ...
            <span class="text-gray-500 mt-1 fw-semibold fs-6">
                {{ $chartPerformance['inboundCallsToday'] ?? '1,046 Inbound Calls today' }}
            </span>
        </h3>
        <div class="card-toolbar">
            <div data-kt-daterangepicker="true" class="btn btn-sm btn-light d-flex align-items-center px-4">
                <div class="text-gray-600 fw-bold">Loading date range...</div>
                {!! getIcon('calendar-8', 'fs-1 ms-2 me-0') !!}
            </div>
        </div>
    ...
    <div class="card-body d-flex align-items-end p-0">
        <div id="kt_charts_widget_36" class="min-h-auto w-100 ps-4 pe-6" style="height: 300px"></div>
        <!-- Use $chartPerformance['data'] in Blade-JS to draw chart -->
    </div>
</div>
<!--end::Chart widget 36-->