                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="#"
                                ...
                                getIcon('black-right', 'fs-2 text-gray-500') !!}</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-end pe-0">
                            ...
                            <span class="badge badge-light-danger fs-base">{!! getIcon('arrow-down', 'fs-5 text-danger
                                ms-n1') !!} 0.4%</span>
            ...
            <table ...>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $stat['name'] }}</td>
                        <td class="text-end pe-0">
                            <span class="text-gray-600 fw-bold fs-6">{{ $stat['budget'] }}</span>
                        </td>
                        <td class="text-end pe-0">
                        ...
                        <td class="text-end pe-12">
                            <span class="badge py-3 px-4 fs-7 badge-light-primary">{{ $stat['status'] }}</span>
                        </td>
                        <td class="text-end pe-0">
                            <div id="kt_table_widget_14_chart_{{ $loop->index }}" class="h-50px mt-n8 pe-7"></div>
                        </td>
                        <td class="text-end">
