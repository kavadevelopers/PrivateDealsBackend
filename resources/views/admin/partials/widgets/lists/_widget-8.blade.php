...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-header pt-7 mb-5">
        ...
        <div class="card-toolbar">
            <a href="{{ route('admin.dashboard') }}" class="btn btn-sm btn-light">View All</a>
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
    ...
    <div class="card-body pt-0">
        ...
        <div class="m-0">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="{{ image('flags/brazil.svg') }}" class="me-4 w-25px" style="border-radius: 4px"
                    alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="{{ image('flags/turkey.svg') }}" class="me-4 w-25px" style="border-radius: 4px"
                    alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="{{ image('flags/france.svg') }}" class="me-4 w-25px" style="border-radius: 4px"
                    alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="{{ image('flags/india.svg') }}" class="me-4 w-25px" style="border-radius: 4px"
                    alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="{{ image('flags/sweden.svg') }}" class="me-4 w-25px" style="border-radius: 4px"
                    alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
