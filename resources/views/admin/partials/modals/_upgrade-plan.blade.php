                                    ...
                                    <div class="pt-1">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span class="fw-semibold fs-5 text-gray-700 flex-grow-1">Up to 10 Active
                                                Users</span>{!! getIcon('check-circle', 'fs-1 text-success') !!}
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-7">
                                            <span class="fw-semibold fs-5 text-gray-700 flex-grow-1">Up to 30 Project
                                                Integrations</span>{!! getIcon('check-circle', 'fs-1 text-success') !!}
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-7">
                                            <span class="fw-semibold fs-5 text-gray-700 flex-grow-1">Analytics
                                                Module</span>{!! getIcon('check-circle', 'fs-1 text-success') !!}
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-7">
                                            <span class="fw-semibold fs-5 text-muted flex-grow-1">Finance
                                                Module</span>{!! getIcon('cross-circle', 'fs-1') !!}
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-7">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span class="fw-semibold fs-5 text-muted flex-grow-1">Network
                                                Platform</span>{!! getIcon('cross-circle', 'fs-1') !!}
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center">
                                            <span class="fw-semibold fs-5 text-muted flex-grow-1">Unlimited Cloud
                                                Space</span>{!! getIcon('cross-circle', 'fs-1') !!}
                                        </div>
                                        <!--end::Item-->
                                    </div>
                                    <!--end::Body-->
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span class="fw-semibold fs-5 text-gray-700 flex-grow-1">Network
                                                Platform</span>{!! getIcon('check-circle', 'fs-1 text-success') !!}
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center">
                                            <span class="fw-semibold fs-5 text-gray-700 flex-grow-1">Unlimited Cloud
                                                Space</span>{!! getIcon('check-circle', 'fs-1 text-success') !!}
                                        </div>
                                        <!--end::Item-->
                                    </div>
                                    <!--end::Body-->
