<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('findcml.list') }}
    @endsection
            ...
            <div class="card card-flush py-4">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.master.findcml.create') }}" class="btn btn-sm btn-primary">
                            Create
                        </a>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="symbol symbol-50px me-5">
                                                <img class="shimmer lazy"
                                                    data-src="{{ FileUpDownHelper::get_findcml_logo_url($item->logo) }}" />
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('admin.master.findcml.edit', ['uuid' => $item->uuid]) }}"
                                                class="btn btn-primary hover-elevate-up btn-icon btn-sm me-1">
                                                <i class="fas fa-pencil fs-6"></i>
                                            </a>

                                            <form action="{{ route('admin.master.findcml.delete', $item->id) }}"
