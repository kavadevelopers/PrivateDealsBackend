<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('broadcast_notification.list') }}
    @endsection
                            ...
                            <table id="kt_datatable_dom_positioning" class="table table-row-bordered gy-5 gs-7">
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800">
                                        <th class="pe-7">Template Name</th>
                                        <th class="pe-7 text-center">Username</th>
                                        <th class="pe-7 text-center">Mobile</th>
                                        <th class="pe-7 text-center">Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($list as $item)
                                        <tr>
                                            <td>{{ ucfirst($item->template_name) }}</td>
                                            <td class="text-center">{{ $item->username }}</td>
                                            <td class="text-center">{{ $item->destination_mobile_no }}</td>
