<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('company-deals.edit') }}
    @endsection

    <div class="d-flex flex-column flex-lg-row">
        <div class="w-100 flex-lg-row-auto w-lg-1200px mb-7 me-7 me-lg-10">
            <form class="form" method="POST" action="{{ route('admin.company-deals.update', ['uuid' => $item->uuid]) }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body pt-0">
                        <div class="d-flex flex-wrap gap-10 mb-5">
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <select class="form-select" name="created_by_seller_id" data-control="select2" data-placeholder="Admin (self)">
                                    ...
                                    @endphp
                                    <option value="{{ $seller->id }}" {{ (string) old('created_by_seller_id', $item->created_by_seller_id) === (string) $seller->id ? 'selected' : '' }}>
                                        {{ $sellerLabel }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="d-flex flex-wrap gap-10 mb-5">
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <select class="form-select" name="company_id" data-control="select2" data-placeholder="Select company" required>
                                    ...
                                    <option value="{{ $company->id }}" {{ (string) old('company_id', $item->company_id) === (string) $company->id ? 'selected' : '' }}>
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <select class="form-select" name="deal_type" required>
                                    ...
                                    <option value="{{ $dealType->value }}" {{ old('deal_type', $item->deal_type) == $dealType->value ? 'selected' : '' }}>
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <select class="form-select" name="status" required>
                                    ...
                                    <option value="{{ $status->value }}" {{ old('status', $item->status) == $status->value ? 'selected' : '' }}>
                        ...
                        <div class="d-flex flex-wrap gap-10 mb-5">
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <input placeholder="e.g. 1000" name="available_quantity"
                        ...
                        <div class="d-flex flex-wrap gap-10 mb-5">
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <input placeholder="e.g. 10" name="minimum_qty"
                        ...
                        <div class="d-flex flex-wrap gap-10 mb-5">
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <input name="expired_at"
                                    value="{{ old('expired_at', $item->expired_at?->format('Y-m-d\\TH:i')) }}"
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <div class="form-check form-switch form-check-custom form-check-solid mt-3">
                                    <input class="form-check-input" type="checkbox" name="is_hot_deal" value="1"
                                        {{ old('is_hot_deal', $item->is_hot_deal) ? 'checked' : '' }} />
