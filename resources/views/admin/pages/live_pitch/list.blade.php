            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.startup.livepitch.create') }}" class="btn btn-sm btn-primary">
                            Create
                        </a>
                    </div>
                </div>
                                    ...
                                    @foreach ($list as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('admin.startup.livepitch.edit', ['livepitch' => $item->uuid]) }}"
                                                    class="btn btn-primary hover-elevate-up btn-icon btn-sm me-1">
                                                    <i class="fas fa-pencil fs-6"></i>
                                                </a>
                                                <!-- Delete Form -->
                                                <form
                                                    action="{{ route('admin.startup.livepitch.destroy', ['livepitch' => $item->uuid]) }}"
