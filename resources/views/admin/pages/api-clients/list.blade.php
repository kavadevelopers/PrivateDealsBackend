            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.systemConfiguration.apiclient.create') }}"
                            ...
                            <table id="kt_datatable_dom_positioning"
                                ...
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800">
                                        ...
                                        <th class="pe-7">Token</th>
                                        <th class="pe-7">Allowed Domains</th>
                                ...
                                <tbody>
                                    @foreach ($list as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->token }}</td>
                                            <td>{{ $item->allowed_domains }}</td>
                                            <td>{{ $item->is_ai ? 'AI AutoWork' : 'Normal' }}</td>
                                            <td class="text-center">
                                                <a href="{{ route('admin.systemConfiguration.apiclient.edit', ['apiclient' => $item->uuid]) }}"
                                                    class="btn btn-primary hover-elevate-up btn-icon btn-sm me-1">
                                                    <i class="fas fa-pencil fs-6"></i>
                                                </a>
                                                <!-- Delete Form -->
                                                <form
                                                    action="{{ route('admin.systemConfiguration.apiclient.destroy', ['apiclient' => $item->uuid]) }}"
