<x-default-layout>
    ...
    <div class="d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
        ...
        @if (isset($item))
            <div class="w-100 flex-lg-row-auto w-lg-400px mb-7 me-7 me-lg-10">
                <form class="form" method="POST"
                    action="{{ route('admin.master.supported-countries.update', ['supported_country' => $item->id]) }}"
                        ...
                        <div class="card-body pt-0" data-select2-id="select2-data-128-idrh">
                            <div class="d-flex flex-column mb-5" data-select2-id="select2-data-127-fpwl">
                                <div class="fv-row fv-plugins-icon-container">
                                    ...
                                    <input name="code" class="form-control mb-2 input input-code" placeholder="Enter code"
                                        tabindex="0" type="text" value="{{ old('code', $item->code) }}">
                                    <div class="text-muted fs-7">Set the code of the sector type.</div>
                                    <div
                            ...
                            <div class="d-flex flex-column gap-10 mb-5">
                                <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                                    ...
                                    <input name="flag" class="form-control mb-2 input" placeholder="Enter flag"
                                        tabindex="0" type="file">
                                    <div class="text-muted fs-7">Select flag size must be (150w x
                                        150h)</div>
                                    <div
                                        class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('admin.master.supported-countries.index') }}" class="btn btn-light me-5">
                                    Cancel
                                </a>
        ...
        @else
            <div class="w-100 flex-lg-row-auto w-lg-400px mb-7 me-7 me-lg-10">
                <form class="form" method="POST" action="{{ route('admin.master.supported-countries.store') }}"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="card card-flush py-4" data-select2-id="select2-data-129-k1bv">
                        <div class="card-header">
                        ...
                        <div class="card-body pt-0">
                            <div class="d-flex flex-column mb-5">
                                <div class="fv-row fv-plugins-icon-container">
                                    <label class="required form-label">Country Code</label>
                                    <input name="code" class="form-control mb-2 input input-code" placeholder="Enter code"
                                        tabindex="0" type="text" value="{{ old('code') }}">
                                    <div class="text-muted fs-7">Set the code of the sector type.</div>
                                    <div
                                        class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                            ...
                            <table id="kt_datatable_dom_positioning" class="table table-row-bordered gy-5 gs-7">
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800">
                                        <th class="pe-7">Flag</th>
                                        <th class="pe-7">Code</th>
                                            ...
                                            <td>
                                                <div class="symbol symbol-50px me-5">
                                                    <img class="shimmer lazy"
                                                        data-src="{{ FileUpDownHelper::get_master_supported_countries_flag_url($item->flag) }}" />
                                                </div>
                                            </td>
                                            <td>{{ ucfirst($item->code) }}</td>
                                            <td>{{ ucfirst($item->name) }}</td>
                                            <td class="text-center">
                                                <a href="{{ route('admin.master.supported-countries.edit', ['supported_country' => $item->id]) }}"
                                                    class="btn btn-primary hover-elevate-up btn-icon btn-sm me-1">
                                                    <i class="fas fa-pencil fs-6"></i>
                                                </a>
                                                <!-- Delete Form -->
                                                <form
                                                    action="{{ route('admin.master.supported-countries.destroy', ['supported_country' => $item->id]) }}"
