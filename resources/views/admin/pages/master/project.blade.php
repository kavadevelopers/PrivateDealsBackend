<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('master.project') }}
    @endsection
    ...
    <div class="d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
        ...
        @if (isset($item))
            <div class="w-100 flex-lg-row-auto w-lg-400px mb-7 me-7 me-lg-10">
                <form class="form" method="POST"
                    action="{{ route('admin.master.project.update', ['project' => $item->id]) }}"
                        ...
                        <div class="card-body pt-0" data-select2-id="select2-data-128-idrh">
                            <div class="d-flex flex-column mb-5" data-select2-id="select2-data-127-fpwl">
                                <div class="fv-row fv-plugins-icon-container">
                                    ...
                                    <input name="project_name" class="form-control mb-2 input" placeholder="Enter Name"
                                        tabindex="0" type="text"
                                        value="{{ old('project_name', $item->project_name) }}">
                                    <div class="text-muted fs-7">Set the project name of the project type.</div>
                                    <div
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('admin.master.project.index') }}" class="btn btn-light me-5">
                                    Cancel
                                </a>
        ...
        @else
            <div class="w-100 flex-lg-row-auto w-lg-400px mb-7 me-7 me-lg-10">
                <form class="form" method="POST" action="{{ route('admin.master.project.store') }}"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="card card-flush py-4" data-select2-id="select2-data-129-k1bv">
                        <div class="card-header">
                        ...
                        <div class="card-body pt-0">
                            <div class="d-flex flex-column mb-5">
                                <div class="fv-row fv-plugins-icon-container">
                                    <label class="required form-label">Name</label>
                                    <input name="project_name" class="form-control mb-2 input" placeholder="Enter Name"
                                        tabindex="0" type="text" value="{{ old('project_name') }}">
                                    <div class="text-muted fs-7">Set the project name of the master project.</div>
                                    <div
                                        class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                                    ...
                                    @foreach ($list as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.master.project.edit', ['project' => $item->id]) }}"
                                                    class="btn btn-primary hover-elevate-up btn-icon btn-sm me-1">
                                                    <i class="fas fa-pencil fs-6"></i>
                                                </a>
                                                <!-- Delete Form -->
                                                <form
                                                    action="{{ route('admin.master.project.destroy', ['project' => $item->id]) }}"
