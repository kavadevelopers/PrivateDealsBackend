<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('master.social-media') }}
    @endsection
    ...
    <div class="d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
        ...
        @if (isset($item))
            <div class="w-100 flex-lg-row-auto w-lg-400px mb-7 me-7 me-lg-10">
                <form class="form" method="POST"
                    action="{{ route('admin.master.social-media.update', ['social_medium' => $item->id]) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body pt-0" data-select2-id="select2-data-128-idrh">
                            <div class="d-flex flex-column gap-10 mb-5" data-select2-id="select2-data-127-fpwl">
                                ...
                                <div class="fv-row fv-plugins-icon-container">
                                    ...
                                    <div class="text-muted fs-7">Set the name of the social media.</div>
                                ...
                                {{-- <div class="d-flex flex-column gap-10 mb-5" data-select2-id="select2-data-127-fpwl">
                                    ...
                                    <div class="fv-row fv-plugins-icon-container">
                                        ...
                                        <div class="text-muted fs-7">Set the display order of the master social-media.</div>
                            ...
                            <div class="d-flex flex-column gap-10 mb-5" data-select2-id="select2-data-127-fpwl">
                                ...
                                <div class="fv-row fv-plugins-icon-container">
                                    ...
                                    <label class="required form-label">Icon(fa-facebook)</label>
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('admin.master.social-media.index') }}" class="btn btn-light me-5">
                                    Cancel
                                </a>
        ...
        @else
            <div class="w-100 flex-lg-row-auto w-lg-400px mb-7 me-7 me-lg-10">
                <form class="form" method="POST" action="{{ route('admin.master.social-media.store') }}">
                    @csrf
                        ...
                        <div class="card-body pt-0" data-select2-id="select2-data-128-idrh">
                            ...
                            <div class="d-flex flex-column gap-10 mb-5" data-select2-id="select2-data-127-fpwl">
                                ...
                                <div class="fv-row fv-plugins-icon-container">
                                    ...
                                    <div class="text-muted fs-7">Set the icon of the social media.</div>
                                    ...
                                    @foreach ($socialmediaList as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.master.social-media.edit', ['social_medium' => $item->id]) }}"
                                                    class="btn btn-primary hover-elevate-up btn-icon btn-sm me-1">
                                                    <i class="fas fa-pencil fs-6"></i>
                                                </a>
                                                <!-- Delete Form -->
                                                <form
                                                    action="{{ route('admin.master.social-media.destroy', ['social_medium' => $item->id]) }}"
