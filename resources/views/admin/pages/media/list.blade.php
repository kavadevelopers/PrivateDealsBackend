<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('cms.media.list') }}
    @endsection
            ...
            <div class="card card-flush py-4">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.cms.media.create') }}" class="btn btn-sm btn-primary">
                            Create
                        </a>
                    </div>
                </div>
                                    ...
                                    @foreach ($list as $item)
                                        <tr>
                                            <td>
                                                <div class="symbol symbol-50px me-5">
                                                    <img class="shimmer lazy"
                                                        data-src="{{ FileUpDownHelper::get_website_media_banner_url($item->banner) }}" />
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <!-- Delete Form -->
                                                <form
                                                    action="{{ route('admin.cms.media.destroy', ['id' => $item->id]) }}"
