<x-default-layout>
    ...
    <div class="d-flex flex-column flex-lg-row">
        <div class="w-100 flex-lg-row-auto w-lg-1200px mb-7 me-7 me-lg-10">
            <form class="form" method="POST" action="{{ route('admin.coupon.store') }}" id="couponForm">
                @csrf
                        ...
                        <div class="d-flex flex-wrap gap-10 mb-5">
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <input name="code" class="form-control mb-2 input" placeholder="Enter Coupon Code"
                                    type="text" value="{{ old('code') }}" style="text-transform: uppercase;">
                        ...
                        <div class="d-flex flex-wrap gap-10 mb-5">
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <select class="form-select" name="applies_on" required>
                                    ...
                                    <option value="all" {{ old('applies_on')=='all' ? 'selected' : '' }}>All
                                        Transactions</option>
                                    <option value="primary" {{ old('applies_on')=='primary' ? 'selected' : '' }}>Primary
                                    </option>
                                    <option value="secondary" {{ old('applies_on')=='secondary' ? 'selected' : '' }}>
                                        Secondary</option>
                                    <option value="pre_ipo" {{ old('applies_on')=='pre_ipo' ? 'selected' : '' }}>Pre-IPO
                                    </option>
                                </select>
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <select class="form-select" name="company_scope" id="company_scope" required>
                                    ...
                                    <option value="{{ $scope->value }}" {{ old('company_scope')===$scope->value ?
                                        'selected' : '' }}>
                                        {{ $scope->value }}
                                    </option>
                                    @endif
                                                        ...
                                                        <td>
                                                            <div
                                                                ...
                                                                <input class="form-check-input company-checkbox"
                                                                    ...
                                                                    value="{{ $company->id }}" {{-- For create blade:
                                                                    --}} {{ in_array($company->id, old('company_ids',
                                                                [])) ? 'checked' : '' }}
                                                                {{-- For edit blade, replace above line with: --}}
                                                                {{-- {{ in_array($company->id, old('company_ids',
                        ...
                        <div class="d-flex flex-wrap gap-10 mb-5">
                            {{-- <div class="fv-row w-100 flex-md-root">
                                ...
                                <select class="form-select" name="created_via">
                                    <option value="manual" {{ old('created_via', 'manual' )=='manual' ? 'selected' : ''
                                        }}>Manual</option>
                                    <option value="campaign" {{ old('created_via')=='campaign' ? 'selected' : '' }}>
                                        Campaign</option>
                                    <option value="referral" {{ old('created_via')=='referral' ? 'selected' : '' }}>
                                        Referral</option>
                                </select>
                                @include('admin.partials.form.input-error-message', ['key' => 'created_via'])
                            </div>
                            <div class="fv-row w-100 flex-md-root" id="referral_config_container" style="display:none;">
                                ...
                                <div class="form-check form-switch mb-2">
                                    <input class="form-check-input" type="checkbox" name="assign_to_referrer" value="1"
                                        id="assign_to_referrer" {{ old('assign_to_referrer') ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="assign_to_referred" value="1"
                                        id="assign_to_referred" {{ old('assign_to_referred') ? 'checked' : '' }}>
                                ...
                                <div class="d-flex flex-wrap gap-10">
                                    <div class="fv-row w-100 flex-md-root">
                                        ...
                                        <input type="number" name="referrer_reward_value"
                                            ...
                                            value="{{ old('referrer_reward_value') }}"
                                    ...
                                    <div class="fv-row w-100 flex-md-root">
                                        ...
                                        <input type="number" name="referred_reward_value"
                                            class="form-control mb-2 input" step="0.01" min="0"
                                            value="{{ old('referred_reward_value') }}"
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <div class="form-check form-switch mt-8">
                                    <input class="form-check-input" type="checkbox" name="is_private" value="1"
                                        id="is_private" {{ old('is_private', true) ? 'checked' : '' }}>
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="first_transaction_only"
                                        value="1" id="first_transaction_only" {{ old('first_transaction_only')
                                        ? 'checked' : '' }}>
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="new_user_only" value="1"
                                        id="new_user_only" {{ old('new_user_only') ? 'checked' : '' }}>
