<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('cms.website-social-media') }}
    @endsection
    ...
    <div class="d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
        ...
        @if (isset($item))
            <div class="w-100 flex-lg-row-auto w-lg-400px mb-7 me-7 me-lg-10">
                <form class="form" method="POST"
                    action="{{ route('admin.cms.website-social-media.update', ['website_social_medium' => $item->id]) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body pt-0" data-select2-id="select2-data-128-idrh">
                            <div class="d-flex flex-column gap-10 mb-5" data-select2-id="select2-data-127-fpwl">
                                ...
                                <div class="fv-row fv-plugins-icon-container">
                                    ...
                                    <div class="text-muted fs-7">Set the name of the website social media.</div>
                            ...
                            <div class="d-flex flex-column gap-10 mb-5" data-select2-id="select2-data-127-fpwl">
                                ...
                                <div class="fv-row fv-plugins-icon-container">
                                    ...
                                    <input name="icon" class="form-control mb-2 input" placeholder="Enter Icon"
                                        tabindex="0" type="text" value="{{ old('icon', $item->icon) }}">



                                    <div class="text-muted fs-7">Set the icon of the website social media.</div>
                                ...
                                {{-- <div class="d-flex flex-column gap-10 mb-5" data-select2-id="select2-data-127-fpwl">
                                    ...
                                    <div class="fv-row fv-plugins-icon-container">
                                        ...
                                        <div class="text-muted fs-7">Set the display order of the master website-social-media.</div>
                            ...
                            <div class="d-flex flex-column gap-10 mb-5" data-select2-id="select2-data-127-fpwl">
                                ...
                                <div class="fv-row fv-plugins-icon-container">
                                    ...
                                    <input name="link" class="form-control mb-2 input" placeholder="Enter url"
                                        tabindex="0" type="text" value="{{ old('link', $item->link) }}">



                                    <div class="text-muted fs-7">Set the url of the website social media.</div>
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('admin.cms.website-social-media.index') }}"
        ...
        @else
            <div class="w-100 flex-lg-row-auto w-lg-400px mb-7 me-7 me-lg-10">
                <form class="form" method="POST" action="{{ route('admin.cms.website-social-media.store') }}">
                    @csrf
                        ...
                        <div class="card-body pt-0" data-select2-id="select2-data-128-idrh">
                            ...
                            <div class="d-flex flex-column gap-10 mb-5" data-select2-id="select2-data-127-fpwl">
                                ...
                                <div class="fv-row fv-plugins-icon-container">
                                    ...
                                    <input name="icon" class="form-control mb-2 input" placeholder="Enter Icon"
                                        tabindex="0" type="text" value="{{ old('icon') }}">
                            ...
                            <div class="d-flex flex-column gap-10 mb-5" data-select2-id="select2-data-127-fpwl">
                                ...
                                <div class="fv-row fv-plugins-icon-container">
                                    ...
                                    <input name="link" class="form-control mb-2 input" placeholder="Enter Url"
                                        tabindex="0" type="text" value="{{ old('link') }}">
                    ...
                    <div class="d-flex flex-column gap-5 gap-md-7">
                        <div class="table-responsive">
                            <table id="kt_datatable_dom_positioning"
                                ...
                                <tbody>
                                    @foreach ($websitesocialmediaList as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.cms.website-social-media.edit', ['website_social_medium' => $item->id]) }}"
                                                    class="btn btn-primary hover-elevate-up btn-icon btn-sm me-1">
                                                    <i class="fas fa-pencil fs-6"></i>
                                                </a>
                                                <!-- Delete Form -->
                                                <form
                                                    action="{{ route('admin.cms.website-social-media.destroy', ['website_social_medium' => $item->id]) }}"
