<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('cms.blog.edit') }}
    @endsection
    ...
    <div class="d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
        ...
        @if (isset($item))
            <div class="w-100 flex-lg-row-auto w-lg-1200px mb-7 me-7 me-lg-10">
                <form class="form" method="POST" action="{{ route('admin.cms.blog.update', ['blog' => $item->id]) }}"
                    ...
                    <div class="card card-flush py-4" data-select2-id="select2-data-129-k1bv">
                        ...
                        <div class="card-body pt-0" data-select2-id="select2-data-128-idrh">
                            <div class="d-flex flex-wrap gap-10" data-select2-id="select2-data-127-fpwl">
                                ...
                                <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                                    ...
                                    <select class="form-select" id="blog_type" name="blog_type" required
                                        ...
                                        <option value="1"
                                            {{ old('blog_type', $item->type) == 1 ? 'selected' : '' }}>
                                            Blog</option>
                                        <option value="2"
                                            {{ old('blog_type', $item->type) == 2 ? 'selected' : '' }}>
                            ...
                            <div class="d-flex flex-wrap gap-10" data-select2-id="select2-data-127-fpwl">
                                ...
                                <div class="fv-row w-100 flex-md-root fv-plugins-icon-container" id="descContainer">

                                    <label class="required form-label">Long Description</label>



                                    <textarea name="long_description" class="form-control mb-2 input kt_docs_tinymce_basic" placeholder="Enter Description"
                                        tabindex="0" type="text">{{ old('long_description', $item->long_description) }}</textarea>
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('admin.cms.blog.index') }}" class="btn btn-light me-5">
                                    Cancel
                                </a>
