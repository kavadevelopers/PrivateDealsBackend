            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.cms.manage-info-icon.create') }}" class="btn btn-sm btn-primary">
                            Create
                        </a>
                    </div>
                </div>
                                    ...
                                    @foreach ($list as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.cms.manage-info-icon.edit', ['manage_info_icon' => $item->id]) }}"
