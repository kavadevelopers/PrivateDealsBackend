<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('cms.manage-info-icon') }}
    @endsection
    ...
    <div class="d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
        ...
        <div class="w-100 flex-lg-row-auto w-lg-1200px mb-7 me-7 me-lg-10">
            <form class="form" method="POST" action="{{ route('admin.cms.manage-info-icon.store') }}">
                @csrf
                    ...
                    <div class="card-body pt-0" data-select2-id="select2-data-128-idrh">
                        ...
                        <div class="d-flex flex-wrap gap-10" data-select2-id="select2-data-127-fpwl">
                            ...
                            <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                                ...
                                <input name="sub_title" class="form-control mb-2 input" placeholder="Enter Sub Title"
                                    tabindex="0" type="text" value="{{ old('sub_title') }}">
                        ...
                        <div class="d-flex flex-wrap gap-10" data-select2-id="select2-data-127-fpwl">
                            ...
                            <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                                ...
                                <input name="link_name" class="form-control mb-2 input" placeholder="Enter Link Name"
                                    tabindex="0" type="text" value="{{ old('link_name') }}">



                                <div class="text-muted fs-7">Set the link name of the manage-info-icon type.</div>
                        ...
                        <div class="d-flex flex-column gap-10" data-select2-id="select2-data-127-fpwl">
                            ...
                            <div class="fv-row fv-plugins-icon-container">
                                ...
                                <textarea name="description" class="form-control mb-2 input" placeholder="Enter Description" tabindex="0"
                                    type="text" value="{{ old('description') }}"></textarea>
