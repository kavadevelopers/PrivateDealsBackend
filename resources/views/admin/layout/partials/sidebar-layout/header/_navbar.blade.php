...
<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-1 ms-md-4">
        ...
        <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px position-relative"
            ...
            <span
                class="bullet bullet-dot bg-success h-6px w-6px position-absolute translate-middle top-0 start-50 animation-blink notificationBubble"
        ...
        {{-- @livewire('admin.livewire.user.notifications-menu') --}}
        <!--end::Menu wrapper-->
    </div>
    <!--end::Notifications-->
    {{-- <!--begin::Chat-->
