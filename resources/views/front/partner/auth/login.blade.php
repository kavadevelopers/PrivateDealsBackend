                    ...
                    <div class="content bg_style">
                        ...
                        <div class="main_content">
                            ...
                            <div class="form" id="loginContent">
                                ...
                                <form action="" data-action="{{ route('front.business.auth.post.login') }}"
                                    {{-- data-redirect="{{ route('front.investor.dashboard') }}"  --}} method="POST" id="login-form">
                                    @csrf
                                    ...
                                    <div class="submit_forget">
                                        ...
                                        <a href="{{ route('front.business.auth.forgot.get') }}" class="forget">Forget
                                            password?</a>
                                    </div>
