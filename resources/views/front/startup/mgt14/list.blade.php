    ...
    <div class="noob tab-pane fade show" id="portfolio" role="tabpanel" aria-labelledby="v-pills-home-tab">
        <div class="top_section">
            ...
            @if (!$last || $last->status != App\Enums\Utills\StatusEnum::pending->value)
                <a href="{{ route('front.raise.mgt14.create') }}" class="btn_custom">
                    <i class="fa-solid fa-circle-plus"></i>
                    <span>Upload MGT-14</span>
                </a>
            @endif
        </div>
        @if ($list->count() > 0)
                        ...
                        <div class="card-item">
                            <div class="row">
                                <div class="col-md-5 col-sm-6 col-xs-12">
                                    <div class="user_info">
                                        <div class="logo">
                                            <img src="{{ asset('front-assets/images/mgt14.jpg') }}" alt="" />
                                        </div>
                                        <div class="name_type">
                                ...
                                <div class="col-md-7 col-sm-6 col-xs-12">
                                    <div>
                                        <div style="text-align: right;" class="mb-4">
                                            <a href="{{ route('download.web', ['path' => $value->challanDocument->signed_path, 'name' => $value->challanDocument->meta->name]) }}"
