                ...
                <div class="container_custom">
                    <div class="content bg_style">
                        ...
                        <div class="main_content">
                            <div class="graphics"><img src="{{ asset('front-assets/images/startup-login-vector.png') }}"
                                    alt=""></div>
                            <div class="form" id="loginContent">
                                ...
                                <form action="" data-action="{{ route('front.raise.auth.post.login') }}" method="POST"
                                    id="startup-login-form">
                                    @csrf
                                    ...
                                    <div class="submit_forget">
                                        ...
                                        <a href="{{ route('front.raise.auth.forgot.get') }}" class="forget">Forget
                                            password?</a>
                                    </div>
                        ...
                        <div class="register_bottom">
                            <p>Don't have any account?</p> <a class="register"
                                href="{{ route('front.raise.auth.apply') }}">Apply for raise</a>
                        </div>
                    </div>
                </div>
            </div>
