...
@endsection
@section('content')
<div class="disclaimer" style="padding-top: 100px; padding-bottom: 60px; background-color: #000000; min-height: 100vh;">
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        {{-- <h2>LEGAL INSIGHTS AND DISCLAIMERS: WEBSITE OR APP CONTENT</h2> --}}
        ...
        <div
            ...
            <p style="line-height: 1.8; margin-bottom: 25px; font-size: 16px; color: #e0e0e0; text-align: justify;">
                ...
                not
                to be treated as investment advice. It does not warrant the accuracy or reliability of the information
                provided on our website www.shuruup.com Prospective buyers and sellers of Private equity and unlisted
                shares
                through the website/application must perform thorough due diligence before proceeding with any
                transactions.
            </p>
            ...
            <p style="line-height: 1.8; margin-bottom: 25px; font-size: 16px; color: #e0e0e0; text-align: justify;">
                ...
                previous performance is not a reliable predictor of future results. No content on this
                website/application
                should be understood as personalized investment advice, nor should it be considered legal, financial, or
                any
            ...
            <p style="line-height: 1.8; margin-bottom: 25px; font-size: 16px; color: #e0e0e0; text-align: justify;">
                ...
                leverage the data at their personal risk.</p>
