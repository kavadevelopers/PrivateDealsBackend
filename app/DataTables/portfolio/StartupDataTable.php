...
class StartupDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        //     ->addColumn('action', 'startup.action')
        //     ->setRowId('id');
        return (new EloquentDataTable($query))
            ->addColumn('startup_name', function ($row) {
                return $row->startup->brand_name ?? '-';
            })
     ...
     */
    public function query(PortfolioModel $model): QueryBuilder
    {
        return $model->where('shares', '>', 0)->with(['startup', 'investor']);
    }
    ...
    {
        return [
            ['data' => 'startup_name', 'name' => 'startup.brand_name', 'title' => 'Startup'],
            ...
            ['data' => 'instrument', 'name' => 'instrument', 'title' => 'Instrument'],
        ];
    }
    ...
    {
        return 'Startup_Portfolio' . date('YmdHis');
    }
}
